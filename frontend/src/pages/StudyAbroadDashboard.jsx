...
import { LogOut, User, Check, X, FileText, Filter } from 'lucide-react';
import axios from 'axios';

const StudyAbroadDashboard = () => {
  ...
  const fetchAllVisits = async () => {
    try {
      ...
      const response = await axios.get('/api/visits/all', { params });
  ...
  const handleStatusChange = async (visitId, newStatus, rejectionReason = '') => {
    try {
      await axios.patch(`/api/visits/${visitId}/status`, {
        status: newStatus,
        rejectionReason
      });
      fetchAllVisits();
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-gray-900">Study Abroad Department</h1>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900">All Visit Requests</h2>
          <div className="flex items-center space-x-2">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            <p className="text-gray-500">Visit requests will appear here once submitted</p>
          </div>
        ) : (
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredVisits.map((visit) => (
                  <tr key={visit.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-500">{visit.division_name}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <>
                            ...
                            <button
                              onClick={() => {
                                ...
                                if (reason) handleStatusChange(visit.id, 'Rejected', reason);
                              }}
