...
import { History, FileText, Download, Eye, Calendar, MapPin, CheckCircle } from 'lucide-react';

const Historico = () => {
  const navigate = useNavigate();
  const { getRequestsByStep, setCurrentRequest } = useDocenteWorkflow();
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {!selectedRequest ? (
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-xl font-semibold text-gray-800 mb-6">Visitas Completadas</h2>
              {historico.length === 0 ? (
